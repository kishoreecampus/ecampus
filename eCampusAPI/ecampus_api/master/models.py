...
institution_name_validator = RegexValidator(r'^[a-zA-Z ]+$', 'only valid trust name is required')
...
section_name_validator = RegexValidator(r'^[a-zA-Z ]+$', 'only valid section name is required')
...
class Section(models.Model):
    ...
    section_name = models.CharField(unique=True, max_length=100, validators=[section_name_validator])
    created_on = models.DateTimeField(auto_now_add=True, null=True)
    created_by = models.IntegerField('created_by')
